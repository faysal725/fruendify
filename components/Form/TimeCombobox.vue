<script setup>
import { ChevronDownIcon, XMarkIcon, ClockIcon } from "@heroicons/vue/24/outline";
...
<template>
  <div>
    ...
    <div class="relative dropdown-container pt-3 w-full">
      <input
        @click="showDropdown"
        ...
        :class="[
          props.disabled
            ...
            : 'bg-transparent  text-gray-700 dark:text-slate-300',
          'w-full h-10 flex items-center text-start pl-2  border border-gray-300 cursor-pointer placeholder:text-gray-700  focus:ring-1 focus:ring-primary text-xs font-base  focus:outline-none capitalize ',
          classes,
        ]"
        ref="searchInput"
      />
