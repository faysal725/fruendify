...
<template>
  <div class="relative cursor-pointer">
    ...
    <!-- something  -->
      <div
        class="h-64 w-full relative bg-no-repeat bg-cover bg-center"
        :style="{ backgroundImage: `url(${networkImage(profile.thumbnail ? profile.thumbnail : profile.user.profile_image)})` }"
      >
        <div
        ...
        >
          ...
          >
            <img
              :src="networkImage(category.image)"
              alt=""
              class="h-4 w-4"
            />
            {{ category.title }}
        ...
        >
          ...
          <div class="flex justify-between text-sm pt-2">
            ...
            <p class="text-center flex items-center gap-2 text-sm text-white">
              ...
              {{ profile?.city ? profile.city : "None" }}
            </p>
          </div>
        </div>
      </div>
