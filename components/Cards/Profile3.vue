        ...
        >
          ...
          <div class="flex justify-between text-sm pt-2">
            <p class="flex items-center gap-1 text-base text-white">
              ...
              {{
                profile?.event?.event_date
                  ? profile.event.event_date.substring(0, 10)
                  : ""
              }}
            </p>
            <p class="text-center flex items-center gap-2 text-base text-white">
              ...
              <!-- {{
                profile.eventDistance
                  ? metersToKilometers(profile.eventDistance) + "KM"
                  : "None"
              }} -->
              {{
                profile?.event?.city &&
                typeof profile?.event?.city !== "undefined"
                  ? profile.event.city
                  : "None"
              }}
            </p>
